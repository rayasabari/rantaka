<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
        <ul class="kt-menu__nav ">
            <li class="kt-menu__item {{ Request::segment(1) == 'home' ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
            ...
            <li class="kt-menu__item {{ Request::segment(1) == 'properti' ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                <a href="{{ url('/properti') }}" class="kt-menu__link ">
                    <span class="kt-menu__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="kt-menu__item {{ Request::segment(1) == 'booking' ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                <a href="{{ url('/booking') }}" class="kt-menu__link ">
                    <span class="kt-menu__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
            ...
            <li class="kt-menu__item {{ Request::segment(1) == 'konfirmasi' ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                <a href="{{ url('/konfirmasi') }}" class="kt-menu__link ">
                    <span class="kt-menu__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <span class="kt-menu__link-text">Konfirmasi</span>
                </a>
            </li>
            <li class="kt-menu__item {{ Request::segment(1) == 'marketing' ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                <a href="{{ url('/marketing') }}" class="kt-menu__link ">
                    <span class="kt-menu__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <polygon points="0 0 24 0 24 24 0 24"/>
            ...
            <li class="kt-menu__item {{ Request::segment(1) == 'project' ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                <a href="{{ url('/project') }}" class="kt-menu__link ">
                    <span class="kt-menu__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <polygon points="0 0 24 0 24 24 0 24"/>
            ...
            <li class="kt-menu__section ">
                <h4 class="kt-menu__section-text">PAGE</h4>   
                <i class="kt-menu__section-icon flaticon-more-v2"></i>
            </li>
            <li class="kt-menu__item {{ Request::segment(1) == 'slider' ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                <a href="{{ url('/slider') }}" class="kt-menu__link ">
                    <span class="kt-menu__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <polygon points="0 0 24 0 24 24 0 24"/>
            ...
            <li class="kt-menu__item {{ Request::segment(1) == 'users' ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
